  ...
  return (
    <div className="headingDiv w-full">
      ...
      <div className="navItems">
        <ul>
          <li className="headerLink font-semibold  flex items-center space-x-2">
            <svg
          ...
          <li className="font-semibold flex items-center space-x-2">
            ...
            <Link to="/cart"> Cart items : {cardItems.length}</Link>
          </li>

          <li className="headerLink flex font-semibold items-center space-x-2">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
